...
// const result = wasm.instance.exports.get(req);
// const ref = Buffer.from(wasm.instance.exports.memory.buffer, result);
// console.log(ref);

// wasm.instance.exports._isResponseText(ptr);
// let optionPtr = wasm.instance.exports._getResponseText(ptr)
// let responseTextPtr = wasm.instance.exports._expectOption(optionPtr);
// let responseText = getString(responseTextPtr);

// _decrPtr(optionPtr);
// _decrPtr(responseTextPtr);
// _decrPtr(ptr);